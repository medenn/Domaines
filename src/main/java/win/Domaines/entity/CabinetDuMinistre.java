...
@Entity
@Table(name = "cabinet_du_ministre")
public class CabinetDuMinistre {
    ...
    @Column(name = "fichier")
    private byte[] fichier;  // fichier PDF, image, document, etc.

    public CabinetDuMinistre() {}

    public CabinetDuMinistre(String titrearabe, String titrefrancais, String descarabe,
                             String descfrancais, byte[] fichier) {
