...
@Entity
@Table(name = "ministerecontenuassocier")
public class MinistereContenuAssocier {
    ...
    public MinistereContenuAssocier() {}

    public MinistereContenuAssocier(String titrearabe, String titrefrancais, String textarabe, String textfrancais) {
